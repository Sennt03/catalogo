...
<section id="redes" class="py-24 bg-white overflow-hidden">
    <div class="max-w-xl mx-auto px-6 text-center">
        ...
        <div class="mt-10 flex justify-center gap-4" data-reveal data-reveal-delay="240">
            ...
            {{-- Instagram (oculto temporalmente)
            ...
            {{-- WhatsApp --}}
            <a href="{{ config('services.whatsapp.link') }}" target="_blank" rel="noopener"
            ...
            {{-- TikTok --}}
            <a href="https://www.tiktok.com/@lydanae1?is_from_webapp=1&sender_device=pc" target="_blank" rel="noopener"
...
<footer class="bg-gray-950">
    <div class="max-w-7xl mx-auto px-6 py-10">
        <div class="flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <a href="{{ route('home') }}" class="flex items-center gap-2 flex-shrink-0 bg-white/95 rounded-xl px-3 py-1.5">
                <img src="{{ asset('images/logo.png') }}" alt="Bella Moda" class="h-10 w-auto object-contain block">
            </a>
